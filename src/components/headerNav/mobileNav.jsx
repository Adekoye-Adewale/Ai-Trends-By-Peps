...
export default function MobileNav({ onClick, openNav }) {
        ...
        return (
                <div className={`min-[900px]:hidden fixed top-0 left-full right-0 flex flex-col gap-5 p-10 max-w-[800px] w-[95%] h-screen bg-LightColor-100 rounded-l-2xl border border-solid border-LightColor-300 transition-all duration-300 ${openNav ? 'translate-x-[-99%]' : 'translate-x-[10%]'}`} >
                        <span 
