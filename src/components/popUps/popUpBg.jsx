...
export default function PopUpBg({ children, clickClose }) {
        return (
                <div className='fixed inset-0 size-full bg-DarkColor-900/85 backdrop-blur p-10 z-10'>
                        <div className='relative max-w-4xl size-full py-10 px-5 m-auto bg-mainColor-100 rounded-xl'>
                                <div 
                                        onClick={clickClose}
