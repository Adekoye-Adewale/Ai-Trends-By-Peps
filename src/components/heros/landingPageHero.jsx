...
export default function LandingPageHero() {
        return (
                <section 
                        className="grid place-content-center py-10 sm:py-40 max-w-screen h-screen bg-mainColor-300 overflow-x-hidden bg-no-repeat bg-center bg-cover bg-gradient-to-r from-mainColor-300 via-transparent to-mainColor-300" 
